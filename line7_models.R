...
out_line = model_output(list(fit.4.0, fit.4.1, fit.4.2), "std_EA033", "Line 7 ~ EA033")

write.csv(out_line, "phylogenetic_analysis/line7.csv")
...
plot_1 = ggplot(data.3, aes(y = line_7, 
  ...
  ylab("Line 7: Maximum standardized") + 
  ggtitle("Musical organization of the orchestra (Line 7) vs Jurisdictional hierarchy (EA033)",
