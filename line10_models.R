...
write.csv(out_line, "phylogenetic_analysis/line10.csv")
...
new_data$fit = predict(fit.10.3.3, new_data)
...
plot_1 = ggplot(data.10, aes(y = line_10, 
  ...
  ylab("Line 10: Maximum standardized") + 
  ggtitle("Text Repetition (Line 10) vs Subsistence",
