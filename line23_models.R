...
out_line = model_output(list(fit.23.1.3, fit.23.2.3, fit.23.3.3),
                        ...
                        "Line 23 ~ Class + Caste + Slavery")

write.csv(out_line, "phylogenetic_analysis/line23.csv")
...
plot_1 = ggplot(data.23,  aes(y = line_23, x = std_class)) + 
  ...
  ylab("Line 23: Maximum standardized") + 
  ggtitle("Embellishment (Line 23) vs Class (EA066)",
...
plot_2 = ggplot(data.23,  aes(y = line_23, x = std_caste)) + 
  ...
  ylab("Line 23: Maximum standardized") + 
  ggtitle("Embellishment (Line 23) vs Caste (EA068)")
...
plot_3 = ggplot(data.23,  aes(y = line_23, x = std_slavery)) + 
  ...
  ylab("Line 23: Maximum standardized") + 
  ggtitle("Embellishment (Line 23) vs Slavery (EA070)")
